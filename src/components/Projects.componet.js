...
const Project = () => {
  ...
  const handleAddNewProject = (e, projectName) => {
    ...
    let newProject = {
      name: projectName,
      episodes: 4,
      lastUpdated: "Last edited a week ago",
    };
  ...
  return (
    <>
      ...
      <div
        className={showCNPForm ? "project-Wrapper CNP-blur" : "project-Wrapper"}
      >
        ...
        {!projects.length ? (
          <div className="new-pro-wrapper">
            ...
            <button type="button" className="cnp-btn" onClick={handleCNP}>
              {" "}
              <svg
                width="30"
                height="30"
        ...
        {showCNPForm && (
          <form
            className="cnp-form-wrapper"
            onSubmit={(e) => {
              e.preventDefault();
              handleAddNewProject(e, projectName);
            }}
          >
            ...
            <p
              className={
                !projectName
                  ? "cnp-error show-cnp-error"
                  : "cnp-error hide-cnp-error"
              }
            >
            ...
            <div style={{ float: "right" }}>
              ...
              <button className="form-create-btn" type="submit">
                Create
              </button>
            </div>
          </form>
